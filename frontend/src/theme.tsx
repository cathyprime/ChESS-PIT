    ...
    copy: common(
      {
        ...
        pages: {
          ...
          uploadBody: "Bring a Linux UCI engine, describe its nature, and give it a transparent woodland mask.",
    ...
    copy: common(
      {
        ...
        pages: {
          ...
          uploadBody: "Upload a Linux UCI engine, give it a callsign, and assign a transparent neon mask.",
    ...
    copy: common(
      {
        ...
        pages: {
          ...
          uploadBody: "Upload a Linux UCI engine, describe its character, and give it a transparent woodcut mask.",
